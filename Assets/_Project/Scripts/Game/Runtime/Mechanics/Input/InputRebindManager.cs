...
{
    /// <summary>
    /// Single shared keyboard listener for UI key rebinding. Tracks KeyReference registrations
    /// and binding conflicts. Infra only for now - no rebind-controls screen exists yet.
    /// </summary>
    public sealed class InputRebindManager : IInitializable, IDisposable
    {
        ...
        /// <summary>Begins listening for the next keyboard key and binds it to target.</summary>
        ...
        /// <summary>Ends listening if reference is the active target (e.g. UI disabled).</summary>
