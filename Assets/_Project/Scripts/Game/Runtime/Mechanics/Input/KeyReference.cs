...
namespace Game
{
    ...
    /// <summary>Displays a Key and requests rebinding through InputRebindManager.</summary>
    ...
    public sealed class KeyReference : MonoBehaviour, IPointerClickHandler
    {
        ...
        /// <summary>Debounce after starting listen, read by InputRebindManager.</summary>
        ...
        /// <summary>Called by InputRebindManager when duplicate bindings are detected or cleared.</summary>
        ...
        /// <summary>Called by InputRebindManager when this control becomes the active listen target.</summary>
        ...
        /// <summary>Called by InputRebindManager when rebinding is cancelled or superseded.</summary>
        ...
        /// <summary>Called by InputRebindManager when a new key is chosen.</summary>
