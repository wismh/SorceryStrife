...
namespace Game
{
    ...
    public sealed class TabManager : MonoBehaviour, ITabSelectionMediator
    {
        ...
        /// <summary>Raised when the active tab is selected again and TabReSelectBehavior.Refresh is set.</summary>
        ...
        public void RequestSelection(int tabIndex)
        {
            ...
            {
                LoggingSystem.LogWarning($"{nameof(TabManager)}: invalid tab index {tabIndex}.");
                return;
            }
